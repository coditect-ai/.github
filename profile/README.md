...
- **Tech Stack:** Terraform, GCP, Kubernetes
- **Resources:** Cloud Run, GKE, VPC, IAM, Cloud Build
- **Monitoring:** Prometheus, Grafana, Cloud Logging
- **Security:** Zero-trust architecture, encryption at rest/transit

#### **🔗 [coditect-citus-django-infra](https://github.com/coditect-ai/coditect-citus-django-infra)**

Alternative Django + Citus infrastructure for horizontal scaling.

- **Tech Stack:** Django, Citus (distributed PostgreSQL)
- **Purpose:** Horizontal scaling for multi-tenant workloads
- **Features:** Distributed database, tenant sharding
